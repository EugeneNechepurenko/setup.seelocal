...
// Create And Edit
    $model->onCreateAndEdit(function () {
        return $form = AdminForm::panel()->addBody([
            ...
            AdminFormElement::text('price_0')->setLabel('Price 1 (£)')->required(),
            AdminFormElement::text('price_1')->setLabel('Price 2 (£)')->required(),
            AdminFormElement::text('price_2')->setLabel('Price 3 (£)')->required(),
           ]
        );
    });
});